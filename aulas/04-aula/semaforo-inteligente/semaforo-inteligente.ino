...
/* Variável que seleciona o modo de operação do semáforo 0: Modo aberto para carros e 1: Modo travessia de pedestres. */
int modo = 0;
...
void setup() {
  ...
  /* Ativa a função de interrupção no pino que o sensor está ligado. */
...
/* Função que ativa os LEDs para o modo “Travessia de pedestres” */
void travessia() {
  ...
  */
  ...
  /* Após a travessia de pedestre, altera para o modo de passagem de carros: 0. */
  modo = 0;
}
